...
import { createActaReunion } from '../../servicios/actas.service.jsx';
      ...
      <main className="actas-layout">
        ...
        <section className="actas-hero">
          <div className="actas-hero__content">
            ...
            <p>
             Registre los puntos que se llevaron a cabo en la entrevista. Por favor, complete todos los campos.  
            </p>
            <div className="actas-hero__meta">
              ...
              <article className="actas-meta-card">
                ...
                <strong>{formData.idreservarentrevista || 'No disponible'}</strong>
              </article>
              <article className="actas-meta-card">
                <span>Fecha</span>
        ...
        <section className="actas-form">
          ...
          <div className="actas-form__grid">
            ...
            <div className="actas-field">
              ...
              <select id="motivo" name="idmotivo" value={formData.idmotivo} onChange={handleChange}>
            ...
            <div className="actas-field">
              ...
              <select id="materia" name="idmateria" value={formData.idmateria} onChange={handleChange}>
